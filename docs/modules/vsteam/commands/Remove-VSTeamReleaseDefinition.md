...
custom_edit_url: https://github.com/MethodsAndPractices/vsteam/edit/master/.docs/Remove-VSTeamReleaseDefinition.md
description: 
keywords:
  - vsteam
  - cmdlet
...
```
Remove-VSTeamReleaseDefinition -Id <Int32[]> [-Force] [-ProjectName] <String> [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
